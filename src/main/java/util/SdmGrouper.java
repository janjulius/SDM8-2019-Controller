...
public class SdmGrouper {
	...
	private static final SdmMessage[][] trackOccupiedGroups = new SdmMessage[][] { 
		new SdmMessage[] {
				...
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.CYCLE, 1, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 2, ComponentType.TRAFFIC_LIGHT, 0), 2)
		},
		new SdmMessage[] {
				...
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.CYCLE, 4, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 6, ComponentType.TRAFFIC_LIGHT, 0), 2)
	...
	private static final SdmMessage[][] trackFreeGroups = new SdmMessage[][] {
		new SdmMessage[] {
				...
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.MOTORISED, 6, ComponentType.TRAFFIC_LIGHT, 0), 2),
		...
		new SdmMessage[] {
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.MOTORISED, 4, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.MOTORISED, 7, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.MOTORISED, 2, ComponentType.TRAFFIC_LIGHT, 0), 2),
		},
		new SdmMessage[] {
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.CYCLE, 0, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.CYCLE, 1, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.CYCLE, 2, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.CYCLE, 3, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.CYCLE, 4, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 0, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 1, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 2, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 6, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 3, ComponentType.TRAFFIC_LIGHT, 0), 2),
				new SdmMessage(new SdmTopic(Constants.CONNECTED_TEAM, LaneType.FOOT, 4, ComponentType.TRAFFIC_LIGHT, 0), 2),
